                ...
                <Box sx={{display: {xs: 'none', sm: 'block'}}} className="gallery-cards__photos">
                    <div className="gallery-cards-photos__block1">
                        <div className="gallery-cards-photos__block1_1">
                            <img src="/healing-demo/public/4.jpg" alt="Фото" className="gallery-cards-photos__block1_1-photo1"/>
                            <img src="/healing-demo/public/2.jpg" alt="Фото" className="gallery-cards-photos__block1_1-photo2"/>
                        </div>

                        <div className="gallery-cards-photos__block1_2">
                            <img src="/healing-demo/public/g3.jpg" alt="Фото" className="gallery-cards-photos__block1_2-photo1"/>
                        </div>
                    </div>

                    <div className="gallery-cards-photos__block2">
                        <img src="/healing-demo/public/g4.jpg" alt="Фото" className="gallery-cards-photos__block2_photo1"/>
                        <img src="/healing-demo/public/n1.jpg" alt="Фото" className="gallery-cards-photos__block2_photo2"/>
                    </div>

                    <div className="gallery-cards-photos__block3">
                        <div className="gallery-cards-photos__block3_1">
                            <img src="/healing-demo/public/g3.1.jpg" alt="Фото"
                                 className="gallery-cards-photos__block3_1-photo1"/>
                            <img src="/healing-demo/public/IMG_4344.webp" alt="Фото"
                                 className="gallery-cards-photos__block3_1-photo2"/>
                            <img src="/healing-demo/public/g3.3.jpg" alt="Фото"
                                 className="gallery-cards-photos__block3_1-photo3"/>
                        </div>

                        <div className="gallery-cards-photos__block3_2">
                            <img src="/healing-demo/public/bser.jpg" alt="Фото"
                                 className="gallery-cards-photos__block3_2-photo1"/>
                            <img src="/healing-demo/public/3.jpg" alt="Фото" className="gallery-cards-photos__block3_2-photo2"/>
                        </div>
                    </div>

                    <div className="gallery-cards-photos__block4">
                        <div className="gallery-cards-photos__block4_1">
                            <img src="/healing-demo/public/g4.1.jpg" alt="Фото"
                                 className="gallery-cards-photos__block4_1-photo1"/>
                        </div>

                        <div className="gallery-cards-photos__block4_2">
                            <img src="/healing-demo/public/g4.2.jpg" alt="Фото"
                                 className="gallery-cards-photos__block4_2-photo1"/>
                            <img src="/healing-demo/public/g4.3.jpg" alt="Фото"
                ...
                <Box sx={{display: {xs: 'block', sm: 'none'}}} className="gallery-cards__photos">
                    ...
                    >
                        <div className="gallery-cards__photo-wrapper-mobile">
                            <img src="/healing-demo/public/4.jpg" alt="Фото"/>
                        </div>

                        <div className="gallery-cards__photo-wrapper-mobile">
                            <img src="/healing-demo/public/g4.jpg" alt="Фото"/>
                        </div>

                        <div className="gallery-cards__photo-wrapper-mobile">
                            <img src="/healing-demo/public/n1.jpg" alt="Фото"/>
                        </div>
                        ...
                        <div className="gallery-cards__photo-wrapper-mobile">
                            <img src="/healing-demo/public/3.jpg" alt="Фото"/>
                        </div>
                        <div className="gallery-cards__photo-wrapper-mobile">
                            <img src="/healing-demo/public/g4.1.jpg" alt="Фото"/>
                        </div>
